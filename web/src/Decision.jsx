              ...
              <>
                ...
                {jw.jeonse.risk.priority_krw > 0 && (
                  <li>
                    ...
                    선순위 근저당보다 먼저 배당받아요
                    <div className="cite">
                      주택임대차보호법 §8, 시행령 §10 제1호·§11 제1호 · 서울 기준
                      (법제처 법령 원문, 시행 2026-07-01)
                    </div>
                  </li>
                )}
                {jw.jeonse.risk.adjusted && jw.jeonse.risk.priority_supported === false && (
                  // 지역이 서울이 아니거나 모를 때. 조용히 0으로 두면 사용자는 왜
                  // 보호가 없는지 모른다 — 실제로는 지역별로 받을 수 있는 금액이 있다.
                  <li>
                    <b>소액임차인 최우선변제는 아직 서울 범위만 가능합니다.</b> 이 매물은 서울로
                    확인되지 않아 보호액을 <b>0으로 두고</b> 계산했어요 — 실제로는 받을 수 있는
                    금액이 있어 <b>기대손실이 실제보다 크게</b> 잡혔을 수 있습니다.
                    <div className="cite">
                      시행령 §10·§11은 지역을 4구간으로 나눠요(서울 5,500만 / 과밀억제권역 4,800만 /
                      광역시 2,800만 / 그 밖 2,500만). 서울 값을 전국에 쓰면 반대로 위험이
                      과소평가되므로, 확인 전까지 보호를 얹지 않습니다.
                    </div>
                  </li>
                )}
              </>
      ...
      {jw && (
        ...
        <section className="limits">
          ...
          <ul>
            ...
            <li>
              <b>소액임차인 최우선변제는 서울만 지원합니다</b>(보증금 1억 6,500만원 이하 →
              5,500만원까지). 법령 원문은 지역을 4구간으로 나누고 금액이 2배 이상 갈리는데,
              서울 밖 매물은 <b>보호를 0으로 두고</b> 계산해요 — 없는 보호를 얹어 위험을
              낮춰 보이게 하는 것보다 안전한 방향입니다.
            </li>
            <li>
